...
var check = function() {
	      document.getElementById('loginEmail').style.borderColor  = '#00CCCC';
	      document.getElementById('mess').innerHTML   = "";
	  }

</script>
<mt:login_template title="Login">
	...
	<form method="post" action="${pageContext.request.contextPath }/account">
		...
		<div class="inputGroup inputGroup1">
			<label for="loginEmail" id="loginEmailLabel">Username</label> <input
					type="text" id="loginEmail" style="${style}" onchange="check()" name="username" maxlength="32" value="${username }" placeholder="username"/>
			
		</div>
		<div class="inputGroup inputGroup2">
			<label for="loginPassword" id="loginPasswordLabel">Password</label> <input
					type="password" id="loginPassword" placeholder="password" name="password" /> <label
